...
public class Main {
    public static void main(String[] args) {
        ...
        //TODO f) wypisz top 5 lekarzy co mieli najwiecej wizyt
        System.out.println("5 lekarzy z najwieksza iloscia wizyt: ");
        Doctor.busiestDoctors(5).forEach(System.out::println);
        System.out.println();

        //TODO g) zwroc pacientow ktorzy byli u minumum 5ciu roznych lekarzy
        ...
        //TODO h) zwroc lekarzy ktorzy przyjeli tylko jednego pacjenta
        System.out.println("Lekarze z tylko jednym pacjentem: ");
        Doctor.doctorsWithXPatients(1).forEach(System.out::println);
    }
}
